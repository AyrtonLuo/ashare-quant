"""
engine.py — Deterministic Quantitative Backtest Engine with Point-in-Time Protection.
"""
...
class BacktestEngine:
    """Simulates daily portfolio evolution using Point-in-Time historical datasets."""
