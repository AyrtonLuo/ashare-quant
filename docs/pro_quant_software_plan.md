...
- 数据层：Data Pipeline 2.0 (MarketData 模型、MarketDataProvider 抽象、AkShareProvider、FutuProvider、LocalCache Parquet 缓存、HistoricalUniverseProvider PIT 支持、DataQualityChecker 质量校验与异动预警、DemoMarketDataProvider 演练数据源).
